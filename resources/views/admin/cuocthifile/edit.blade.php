            ...
            <div class="x_panel">
               ...
               <div class="x_content">
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <?php foreach ($cuocthi as $key => $value): ?>
                           <option value="{{ $value->id }}" @if ($value->id == $data['cuocthi_id']) selected @endif>{{ $value->ten }}</option>
                        <?php endforeach ?>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="ten_tep" id="ten_tep" value="{{ $data->ten_tep}}" required="required" class="form-control col-md-7 col-xs-12">
