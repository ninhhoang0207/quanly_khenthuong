			...
			<div class="col-md-12 col-sm-12 col-xs-12">
				<div class="x_panel">
					...
					<div class="x_title">
						...
						<a href="{{ route('admin.xa.create') }}" class="btn btn-primary pull-right">Thêm mới</a>
						<div class="clearfix"></div>
					</div>
					<!-- X-title -->
						...
						<table class="table" id="table-category">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $value->huyen->ten }}</td>
									<td>{{ $value->ten }}</td>
									<td>
										<a href="{{ route('admin.xa.edit', ['id'=>$value->id]) }}" class="btn btn-warning btn-xs">Sửa</a>
										<a onclick="getModalDelete('{{ route('admin.xa.delete', ['id'=>$value->id]) }}')" class="btn btn-danger btn-xs">Xóa</a>
									</td>
								</tr>
								@endforeach
							</tbody>
