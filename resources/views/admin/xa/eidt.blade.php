               ...
               <div class="x_content">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <option disabled selected id="store_id_none"></option>
                         <?php foreach ($tinh as $key => $value): ?>
                           <option @if ($value->id == $data['tinh_id']) selected @endif value="{{ $value->id }}">{{ $value->ten }}</option>
                        <?php endforeach ?>
                        </select>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" id="tinh_id" name="tinh_id" required>
                        <option disabled selected id="store_id_none"></option>
                         <?php foreach ($huyện as $key => $datas): ?>
                           <option @if ($datas->id == $data['tinh_id']) selected @endif value="{{ $datas->id }}">{{ $datas->ten }}</option>
                        <?php endforeach ?>
                        </select>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="ten" id="ten" value="{{ $data->ten}}" required="required" class="form-control col-md-7 col-xs-12">
                        @if($errors->has('ten'))
