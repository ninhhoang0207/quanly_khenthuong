               ...
               <div class="x_content">
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="ten" id="ten" required="required" value="{{ $data->ten }}" class="form-control col-md-7 col-xs-12">
                        @if($errors->has('ten'))
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input id="thoihan_thamgia" type="text" name="thoihan_thamgia" value="{{ $data->thoihan_thamgia }}" class="form-control col-md-7 col-xs-12" placeholder="">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" id="loaihinh" name="loaihinh" required>
                           ...
                           <option value="1" @if($data->loaihinh==1) selected="" @endif>Cá nhân</option>
                           <option value="2" @if($data->loaihinh==2) selected @endif>Tổ chức</option>
                        </select>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <select class="form-control" id="ban_tochuc" name="ban_tochuc" required>
                           <option disabled selected id="offer_type_none"></option>
                           <option value="5" @if($data->ban_tochuc==5) selected @endif>Tỉnh</option>
                           <option value="4" @if($data->ban_tochuc==4) selected @endif>Huyện</option>
                           <option value="3" @if($data->ban_tochuc==3) selected @endif>Xã</option>
                        </select>
                     </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="text" name="giaithuong" id="giaithuong" value="{{ $data->giaithuong }}" required="required" class="form-control col-md-7 col-xs-12">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <textarea type="text" name="mota" id="mota" class="form-control col-md-7 col-xs-12" rows="5">{{ $data->mota }}</textarea>
                     </div>
                  </div>  
                  <div class="form-group">
