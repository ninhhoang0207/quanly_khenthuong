						...
						<table class="table" id="table-category">
							...
							<tbody>
								...
								<tr>
									...
									<td>{{ $value->ten }}</td>
									<td>
										<a href="{{ route('admin.tinh.edit', ['id'=>$value->id]) }}" class="btn btn-warning btn-xs">Sửa</a>
										<a onclick="getModalDelete('{{ route('admin.tinh.delete', ['id'=>$value->id]) }}')" class="btn btn-danger btn-xs">Xóa</a>
									</td>
								</tr>
								@endforeach
							</tbody>
