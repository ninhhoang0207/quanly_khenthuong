					...
					<div class="x_content">
						...
						<div class="form-group">
							...
							<div class="col-md-9 col-sm-9 col-xs-12">
								<div class="">
									<label>
										<input type="radio" name="status" id="view_mode_all" class="flat" checked value="show" /> Show &nbsp
										<input type="radio" name="status" id="view_mode_member" class="flat" value="hide" />&nbsp Hide
									</label>
								</div>
							</div>
						</div>
