...
<head>
    ...
    <link href="/metronic/assets/pages/css/profile.min.css" rel="stylesheet" type="text/css" />
    <!-- END PAGE LEVEL STYLES -->
    <!-- BEGIN THEME LAYOUT STYLES -->
    <link href="/metronic/assets/layouts/layout4/css/layout.min.css" rel="stylesheet" type="text/css" />
    <link href="/metronic/assets/layouts/layout4/css/themes/light.min.css" rel="stylesheet" type="text/css" id="style_color" />
    <link href="/metronic/assets/layouts/layout4/css/custom.min.css" rel="stylesheet" type="text/css" />

    <link href="/metronic/assets/global/plugins/icheck/skins/all.css" rel="stylesheet" type="text/css" />
    <link href="/metronic/assets/global/css/components-md.min.css" rel="stylesheet" id="style_components" type="text/css" />
    <link href="/metronic/assets/global/plugins/bootstrap-select/css/bootstrap-select.min.css" rel="stylesheet" type="text/css" />
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        ...
        <div class="page-logo">
            <a href="index.html">
                <img src="/metronic/assets/layouts/layout4/img/logo-light.png" alt="logo" class="logo-default" /> </a>
                ...
                <ul class="nav navbar-nav pull-right">
                            ...
                            <li>
                                <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                    ...
                                    <li>
                                        <a href="#">
                                                    <span class="photo">
                                                        <img src="/metronic/assets/layouts/layout3/img/avatar1.jpg" class="img-circle" alt=""> </span>
                                            <span class="subject">
                    ...
                    <li class="dropdown dropdown-user dropdown-dark">
                        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                            ...
                            <img alt="" class="img-circle" src="/metronic/assets/layouts/layout4/img/avatar9.jpg" /> </a>
        ...
        <div class="page-content">
            ...
            <div class="page-head">
                ...
                <div class="page-title">
                    <h1><strong>Thông tin hồ sơ</strong>
                    </h1>
                </div>
                <!-- END PAGE TITLE -->
                <!-- BEGIN PAGE TOOLBAR -->
                    ...
                    <div class="profile-sidebar">
                        ...
                        <div class="portlet light profile-sidebar-portlet bordered">
                            ...
                            <div class="profile-userpic">
                                <img src="/metronic/assets/pages/media/profile/profile_user.jpg" class="img-responsive" alt=""> </div>
                            <!-- END SIDEBAR USERPIC -->
                            <!-- SIDEBAR USER TITLE -->
                            <div class="profile-usertitle">
                                <div class="profile-usertitle-name"> {{$informationsEmployee->hoten}} </div>
                                <div class="profile-usertitle-job"> {{$informationsEmployee->email}} </div>
                            </div>
                                ...
                                <div class="portlet light bordered">
                                    <div class="portlet-title tabbable-line">
                                        <div class="caption caption-md">
                                            ...
                                            <span class="caption-subject font-blue-madison bold uppercase">Hồ sơ cá nhân</span>
                                        </div>
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li>
                                                <a href="#tab_1_2" data-toggle="tab">Thông tin gia đình</a>
                                            </li>
                                            <li>
                                                <a href="#tab_1_3" data-toggle="tab">Quá trình công tác</a>
                                            </li>
                                            <li>
                                                <a href="#tab_1_4" data-toggle="tab">Thành tích</a>
                                            </li>
                                            <li>
                                                <a href="#tab_1_5" data-toggle="tab">Thông báo</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="portlet-body">
                                        <div class="tab-content">
                                            <!-- Thông tin cá nhân -->
                                            @include('admin.nhanvien.thongtincanhan',['thongtincanhan'=>$informationsEmployee])
                                            <!-- Thông tin cá nhân -->
...
<script src="/metronic/assets/pages/scripts/profile.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<!-- BEGIN THEME LAYOUT SCRIPTS -->
<script src="/metronic/assets/layouts/layout4/scripts/layout.min.js" type="text/javascript"></script>
<script src="/metronic/assets/layouts/layout4/scripts/demo.min.js" type="text/javascript"></script>
...
<script src="/metronic/assets/pages/scripts/components-bootstrap-select.min.js" type="text/javascript"></script>
<script src="/metronic/assets/global/plugins/bootstrap-select/js/bootstrap-select.min.js" type="text/javascript"></script>
<script src="/js/app_services.js" type="text/javascript"></script>

{{--<link href="/metronic/assets/css/components-md.min.css" rel="stylesheet" id="style_components" type="text/css" />--}}
