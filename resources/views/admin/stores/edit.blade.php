					...
					<div class="x_content">
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="name" id="name" required="required" class="form-control col-md-7 col-xs-12" value="{{ $store->name }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="website" id="website" required="required" class="form-control col-md-7 col-xs-12" value="{{ $store->website }}">
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<input type="text" name="email" id="email" required="required" class="form-control col-md-7 col-xs-12" value="{{ $store->email }}">
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								...
								<div class="form-group">
									<img src="{{ Storage::url($store->avatar) }}" class="img img-thumbnail" id="avatar_preview" width="500px" height="auto">
								</div>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-md-6 col-sm-6 col-xs-12">
								<textarea class="form-control" rows="5" name="description" id="description" required>{{ $store->description }}</textarea>
							</div>
						</div>
						<div class="form-group">
