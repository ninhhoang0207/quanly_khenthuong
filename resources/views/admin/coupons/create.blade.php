            ...
            <div class="x_panel">
               ...
               <div class="x_content">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="number" name="discount" id="discount" required="discount" class="form-control col-md-7 col-xs-12">
                     </div>
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-9 col-sm-9 col-xs-12">
                        <div class="">
                           <label>
                              <input type="radio" name="coupon_type" id="coupon_type" class="flat" value="feature" required="" /> Feature &nbsp
                              <input type="radio" name="coupon_type" id="coupon_type" class="flat" value="free" />&nbsp Free
                           </label>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        <input type="input" name="expired" id="expired" required class="form-control col-md-7 col-xs-12">
                     </div>
                  </div>
                  ...
                  <div class="form-group">
                     ...
                     <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                           <img src="" class="img img-thumbnail" id="image_preview" width="500px" height="auto" style="display: none;">
                        </div>
                     </div>
                  </div>
                  <div class="form-group">
